...
const previewFolder = path.join(websiteRoot, "src/assets/previews");
const outputDir = path.join(websiteRoot, 'src/assets/previews');
...
const PATHS = {
  ...
  pdfSource: path.join(websiteRoot, 'src/assets/pdfs'),
  imgOutput: path.join(websiteRoot, 'src/assets/previews'),
